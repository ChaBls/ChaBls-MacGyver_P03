...
class Game:
    def __init__(self):
        ...
        self.item_dict={}
        # empty attributes
        self.wall_picture="Config/assets/wall.png"
        ...
        for coorLine, line in enumerate(file):
            ...
            for coorLetter, letter in enumerate(line):
                ...
                if letter == '\n':
                    ...
                    self.guardian=Guardian(type="ennemy", x=coorLetter, y=coorLine, image=pygame.image.load("Config/assets/Gardien.png").convert_alpha())
                elif letter == 'P':
                    self.player=MacGyver(x=coorLetter, y=coorLine, image=pygame.image.load("Config/assets/MacGyver.png").convert_alpha())
            ...
            for j in range(0,15):
                ...
                if (i,j) in self.walls:
                    ...
                    if self.player.high == True:
                        self.wall_picture="Config/assets/Groovy.png"
                    ...
                    """
                    floor_img = pygame.image.load("Config/assets/floor.png").convert_alpha()
